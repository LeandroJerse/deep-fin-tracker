    ...
    <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-primary-foreground/80 text-sm">
              Intelligent shark monitoring system for marine conservation and coastal safety.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="https://github.com/LeandroJerse/FinStream_Nasa" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-primary-foreground/80 hover:text-primary-foreground transition-colors text-sm">
        ...
        <div className="border-t border-primary-foreground/10 pt-8 text-center text-sm text-primary-foreground/60">
          <p>&copy; 2025 SharkTrack AI. All rights reserved. MVP developed for demonstration.</p>
        </div>
      </div>
    </footer>
  );
